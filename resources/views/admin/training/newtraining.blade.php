  ...
  <div class="col-lg-6">
      <form method="POST" action="{{ route('savetraining') }}">
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            <div class="input-group date" id="datetimepicker">
                                <input class="form-control date" name="tanggal_mulai" value="{{ old('tanggal_mulai') }}">
        ...
        <div>
            <label>Date End</label>
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <div class="input-group date" id="datetimepicker">
                                <input class="form-control date" name="tanggal_akhir" value="{{ old('tanggal_akhir') }}">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                </span>
                                <script type="text/javascript">
                                    $('.date').datepicker({  
          ...
          <button type="submit" class="btn btn-success" value="save">Submit Button</button>
