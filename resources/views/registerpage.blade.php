    ...
    <div class="col-lg-10">
        ...
        <form role="form" method="POST" action="/register">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input class="form-control" name = "nama" value="{{ old('nama') }}" autofocus required>
                    </div>
                </div>
            </div>
            <!-- Jenis Kelamin -->
            ...
            <div class="form-group">
                ...
                <textarea value="{{ old('alamat') }}"class = "form-control" rows="3" name="alamat" autofocus>{{ old('alamat') }}</textarea>
                </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <textarea name="job_alamat" value="{{ old('job_alamat') }}"class = "form-control" rows="3"  autofocus>{{ old('job_alamat') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <textarea type="text" name="area_interest" id="area_interest" value="{{ old('area_interest') }}"class = "form-control" rows="3" autofocus>{{ old('area_interest') }}</textarea>
                    </div>
                </div>
            </div> 
            <br>
